...
<qgis simplifyMaxScale="1" readOnly="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="0" version="3.34.11-Prizren" labelsEnabled="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <elevation clamping="Terrain" binding="Centroid" extrusion="0" extrusionEnabled="0" showMarkerSymbolInSurfacePlots="0" respectLayerSymbol="1" symbology="Line" zscale="1" zoffset="0" type="IndividualFeatures">
    ...
    <profileLineSymbol>
      <symbol name="" is_animated="0" frame_rate="10" clip_to_extent="1" force_rhr="0" alpha="1" type="line">
        ...
        <layer pass="0" id="{b244b595-269e-4a09-8e8f-e99bfaa49676}" class="SimpleLine" locked="0" enabled="1">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol name="" is_animated="0" frame_rate="10" clip_to_extent="1" force_rhr="0" alpha="1" type="fill">
        ...
        <layer pass="0" id="{e3562707-7b08-4d8c-8029-b0e2332cb1ab}" class="SimpleFill" locked="0" enabled="1">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol name="" is_animated="0" frame_rate="10" clip_to_extent="1" force_rhr="0" alpha="1" type="marker">
        ...
        <layer pass="0" id="{8637943a-25d3-47b7-acea-54d16693cb65}" class="SimpleMarker" locked="0" enabled="1">
          <Option type="Map">
  ...
  <renderer-v2 enableorderby="0" symbollevels="0" attr="&quot;nom_nivel&quot;" referencescale="-1" forceraster="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="" label="&lt;all other values>" uuid="{a505ab25-5ff8-45c6-ad2a-9b323d829a68}" type="string"/>
      <category render="true" symbol="1" value="n" label="n" uuid="{2d7656c0-32a8-47bc-860b-2a5947a72aaa}" type="string"/>
      <category render="true" symbol="2" value="sg" label="sg" uuid="{03ab7e6a-f172-4c75-8dca-393367d55704}" type="string"/>
      <category render="true" symbol="3" value="sga" label="sga" uuid="{34c4a7cd-7458-41a8-b10d-4a0246ab8cf1}" type="string"/>
      <category render="true" symbol="4" value="sgn" label="sgn" uuid="{dcf819ca-f300-4c41-99b1-3c304d5d9c8a}" type="string"/>
    </categories>
    <symbols>
      <symbol name="0" is_animated="0" frame_rate="10" clip_to_extent="1" force_rhr="0" alpha="1" type="marker">
        ...
        <layer pass="0" id="{495838be-daa3-4517-b451-454bce7fa5dc}" class="SimpleMarker" locked="0" enabled="1">
          <Option type="Map">
            <Option name="angle" value="0" type="QString"/>
            <Option name="cap_style" value="square" type="QString"/>
            ...
            <Option name="outline_width_unit" value="MM" type="QString"/>
            <Option name="scale_method" value="diameter" type="QString"/>
            <Option name="size" value="1.47272" type="QString"/>
            <Option name="size_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
      ...
      <symbol name="1" is_animated="0" frame_rate="10" clip_to_extent="1" force_rhr="0" alpha="1" type="marker">
        ...
        <layer pass="0" id="{9f01ad93-a965-4646-9758-4334deeb8df0}" class="SimpleMarker" locked="0" enabled="1">
          <Option type="Map">
            <Option name="angle" value="0" type="QString"/>
            <Option name="cap_style" value="square" type="QString"/>
            <Option name="color" value="195,0,255,255" type="QString"/>
            <Option name="horizontal_anchor_point" value="1" type="QString"/>
            <Option name="joinstyle" value="miter" type="QString"/>
            <Option name="name" value="circle" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
      ...
      <symbol name="2" is_animated="0" frame_rate="10" clip_to_extent="1" force_rhr="0" alpha="1" type="marker">
        ...
        <layer pass="0" id="{ffb274f4-400a-4ebb-ac92-cdc5efa966c3}" class="SimpleMarker" locked="0" enabled="1">
          <Option type="Map">
            <Option name="angle" value="0" type="QString"/>
            <Option name="cap_style" value="square" type="QString"/>
      ...
      <symbol name="3" is_animated="0" frame_rate="10" clip_to_extent="1" force_rhr="0" alpha="1" type="marker">
        ...
        <layer pass="0" id="{7425ade5-e736-4389-ad91-8aecda5eaaad}" class="SimpleMarker" locked="0" enabled="1">
          <Option type="Map">
            <Option name="angle" value="0" type="QString"/>
            <Option name="cap_style" value="square" type="QString"/>
            <Option name="color" value="0,110,255,255" type="QString"/>
            <Option name="horizontal_anchor_point" value="1" type="QString"/>
            <Option name="joinstyle" value="miter" type="QString"/>
            <Option name="name" value="circle" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
      ...
      <symbol name="4" is_animated="0" frame_rate="10" clip_to_extent="1" force_rhr="0" alpha="1" type="marker">
        ...
        <layer pass="0" id="{8b4e1890-7e36-42c5-bff2-870e78bf9eec}" class="SimpleMarker" locked="0" enabled="1">
          <Option type="Map">
            <Option name="angle" value="0" type="QString"/>
            <Option name="cap_style" value="square" type="QString"/>
