...
<qgis simplifyMaxScale="1" readOnly="0" simplifyLocal="1" symbologyReferenceScale="-1" simplifyAlgorithm="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="0" version="3.34.11-Prizren" labelsEnabled="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <elevation clamping="Terrain" binding="Centroid" extrusion="0" extrusionEnabled="0" showMarkerSymbolInSurfacePlots="0" respectLayerSymbol="1" symbology="Line" zscale="1" zoffset="0" type="IndividualFeatures">
    ...
    <profileLineSymbol>
      <symbol name="" is_animated="0" frame_rate="10" clip_to_extent="1" force_rhr="0" alpha="1" type="line">
        ...
        <layer pass="0" id="{ac45ca92-1fd1-42a1-a910-6f12fef4b6c5}" class="SimpleLine" locked="0" enabled="1">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol name="" is_animated="0" frame_rate="10" clip_to_extent="1" force_rhr="0" alpha="1" type="fill">
        ...
        <layer pass="0" id="{843913ed-4c30-4066-b7c4-4baaae9ca71a}" class="SimpleFill" locked="0" enabled="1">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol name="" is_animated="0" frame_rate="10" clip_to_extent="1" force_rhr="0" alpha="1" type="marker">
        ...
        <layer pass="0" id="{e9dc23e5-427f-4d1c-9f24-10664468abbd}" class="SimpleMarker" locked="0" enabled="1">
          <Option type="Map">
  ...
  <renderer-v2 enableorderby="0" symbollevels="0" attr="&quot;nom_nivel&quot;" referencescale="-1" forceraster="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="" label="&lt;all other values>" uuid="{63997a8d-f8e8-4b49-b0fe-ad493340a4d9}" type="string"/>
      <category render="true" symbol="1" value="d" label="d" uuid="{ffba4969-893a-4987-81ba-ff45258a7458}" type="string"/>
      <category render="true" symbol="2" value="m" label="m" uuid="{cf7bc805-3898-4d1f-9498-aaeb53483c66}" type="string"/>
      <category render="true" symbol="3" value="p" label="p" uuid="{b989278d-0310-4171-bef8-d74115977e3c}" type="string"/>
      <category render="true" symbol="4" value="q" label="q" uuid="{2bc4c7f5-f4a5-4732-af0f-96b69b63575e}" type="string"/>
      <category render="true" symbol="5" value="s" label="s" uuid="{c7b38599-e250-4e69-81a0-0293888111ed}" type="string"/>
    </categories>
    <symbols>
      <symbol name="0" is_animated="0" frame_rate="10" clip_to_extent="1" force_rhr="0" alpha="1" type="marker">
        ...
        <layer pass="0" id="{3f8b3481-5387-4776-bb07-3cd130b72914}" class="SimpleMarker" locked="0" enabled="1">
          <Option type="Map">
            <Option name="angle" value="0" type="QString"/>
            <Option name="cap_style" value="square" type="QString"/>
      ...
      <symbol name="1" is_animated="0" frame_rate="10" clip_to_extent="1" force_rhr="0" alpha="1" type="marker">
        ...
        <layer pass="0" id="{0ddd8559-f45f-40a6-9970-b836a87b7b3d}" class="SimpleMarker" locked="0" enabled="1">
          <Option type="Map">
            <Option name="angle" value="0" type="QString"/>
            <Option name="cap_style" value="square" type="QString"/>
            <Option name="color" value="67,156,176,255" type="QString"/>
            <Option name="horizontal_anchor_point" value="1" type="QString"/>
            <Option name="joinstyle" value="miter" type="QString"/>
            <Option name="name" value="circle" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
      ...
      <symbol name="2" is_animated="0" frame_rate="10" clip_to_extent="1" force_rhr="0" alpha="1" type="marker">
        ...
        <layer pass="0" id="{6ed84e25-2b9a-4b65-abfa-e4f2efc23b11}" class="SimpleMarker" locked="0" enabled="1">
          <Option type="Map">
            <Option name="angle" value="0" type="QString"/>
            <Option name="cap_style" value="square" type="QString"/>
            <Option name="color" value="214,139,207,255" type="QString"/>
            <Option name="horizontal_anchor_point" value="1" type="QString"/>
            <Option name="joinstyle" value="miter" type="QString"/>
            <Option name="name" value="circle" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
      ...
      <symbol name="3" is_animated="0" frame_rate="10" clip_to_extent="1" force_rhr="0" alpha="1" type="marker">
        ...
        <layer pass="0" id="{a2a4c407-5c05-4c27-9fd8-3ca41ddbd323}" class="SimpleMarker" locked="0" enabled="1">
          <Option type="Map">
            <Option name="angle" value="0" type="QString"/>
            <Option name="cap_style" value="square" type="QString"/>
            <Option name="color" value="88,214,115,255" type="QString"/>
            <Option name="horizontal_anchor_point" value="1" type="QString"/>
            <Option name="joinstyle" value="miter" type="QString"/>
            <Option name="name" value="circle" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
      ...
      <symbol name="4" is_animated="0" frame_rate="10" clip_to_extent="1" force_rhr="0" alpha="1" type="marker">
        ...
        <layer pass="0" id="{04dc4435-ab8d-4819-ae3c-c5a8636ec7a9}" class="SimpleMarker" locked="0" enabled="1">
          <Option type="Map">
            <Option name="angle" value="0" type="QString"/>
            <Option name="cap_style" value="square" type="QString"/>
            <Option name="color" value="250,90,167,255" type="QString"/>
            <Option name="horizontal_anchor_point" value="1" type="QString"/>
            <Option name="joinstyle" value="miter" type="QString"/>
            <Option name="name" value="circle" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
      ...
      <symbol name="5" is_animated="0" frame_rate="10" clip_to_extent="1" force_rhr="0" alpha="1" type="marker">
        ...
        <layer pass="0" id="{6025062c-d6ad-457e-8075-6f30056f4c83}" class="SimpleMarker" locked="0" enabled="1">
          <Option type="Map">
            <Option name="angle" value="0" type="QString"/>
            <Option name="cap_style" value="square" type="QString"/>
            <Option name="color" value="168,68,61,255" type="QString"/>
            <Option name="horizontal_anchor_point" value="1" type="QString"/>
            <Option name="joinstyle" value="miter" type="QString"/>
            <Option name="name" value="circle" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
